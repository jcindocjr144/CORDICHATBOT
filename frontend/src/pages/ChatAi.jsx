...
const ChatAi = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-b from-blue-50 via-white to-gray-50">
      ...
      <div className="w-full bg-gradient-to-r from-blue-900 to-blue-800 shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex justify-between items-center">
          <h1 className="text-3xl font-bold text-white flex items-center gap-2" 
            ...
            <span className="text-blue-300" onClick={() => navigate('/home')}>Cordi AI</span> Assistant
          </h1>
      ...
      {/* Input area */}
      <div className="flex-none p-6 bg-gradient-to-r from-blue-900 to-blue-800 border-t border-blue-700 shadow-lg">
          ...
          <div className="flex flex-col space-y-3">
            <div className="relative flex items-center">
              <input
                ...
                className="flex-1 min-h-[60px] w-full rounded-2xl border-2 border-blue-300 bg-white px-6 py-4 text-base text-gray-900 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50 transition-all duration-200 pr-16"
                disabled={isLoading}
              />
              <button
                type="submit"
                disabled={isLoading || !input.trim()}
                className="absolute right-2 inline-flex items-center justify-center w-12 h-12 rounded-xl text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
              >
